...
async function saveTask() {
  ...
  try {
    ...
    res = await editTask(props.taskId, statusDetail.value)
    ...
    <div class="flex flex-row gap-3">
      <label class="form-control basis-3/4">
        ...
        <textarea
          ...
          >{{
            statusDetail.description == "" || statusDetail.description === null
      ...
      <div class="mt-2 text-sm text-black">
        <div class="flex flex-row justify-around border-solid border-slate-400">
